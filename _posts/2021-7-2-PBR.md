...
//计算直接光漫反射
half3 diffuseTerm = DisneyDiffuse(nv,nl,lh,roughness,diffColor);//迪士尼漫反射
~~~
...
间接光，Unity里的做法是用GI，这里我是抄一个[大佬](https://zhuanlan.zhihu.com/p/60972473)的思路（代码）
...
![](https://github.com/realburt41/realburt41.github.io/blob/master/img/in-post/PBR/PBR1.png)
